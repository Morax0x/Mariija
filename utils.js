...
STATS: [{ name: "الإحصائيات", value: "✶ `top`\n- عرض قائمة أعلى الناشرين.\n\n✶ `stats [@مستخدم]`\n- عرض إحصائيات الناشر (أو إحصائياتك إذا كنت ناشراً).\n\n✶ `stats @مستخدم #قناة`\n- عرض إجمالي النقاط للناشر في قناة محددة.\n\n✶ `channelstats`\n- عرض إحصائيات النقاط حسب القناة.\n\n✶ `resetstats @مستخدم [all | #ق1 #ق2 ...]`\n- إعادة تعيين نقاط ناشر. (`all` لحذف السجلات بالكامل، أو قنوات محددة).", inline: false }]
},
ERROR_PERM: "✥ مـا عـنـدك صلاحـيات انـقـلـع <a:6bonk:1401906810973327430>",
ERROR_MENTION_USER: { title: "✶ هـمم؟", description: "- حـدد مستخدم على الاقل يا حلو <:0Kkiss:1413810014979887144>" },
ERROR_MENTION_CHANNEL: "✥ منشن قـنـاة او جيب الاي دي بتش <a:6AuraFlick:1414569834884239502>",
ERROR_MENTION_ROLE: "✥ مـنـشن رتبـة يا سـطـل <:5really:1401840911733882983>",
...
ERROR_NO_PUBLISHERS: "ما فيه ناشرين مسجلين بعد <a:6Danceowo:1394655444064276500>",
ERROR_NO_STATS: "مو مسجل كـ ناشـر بعد سجله كـ نـاشـر اولا عشان تطلع الاحصائيات",
ERROR_NO_STATS_TITLE: "✥ المستخدم: {tag}",
ERROR_NO_CHANNELS_SET: "لم يتم تعيين قنوات للمراقبة بعد <:0bored:1395674758175133748>",
ERROR_SQL: "حدث خطأ في قاعدة البيانات أثناء تنفيذ الأمر.",
ERROR_STATS_SELF_NOT_PUBLISHER: { title: "لست ناشراً بعد!", description: "لا يمكنك عرض إحصائياتك لأنك لست مسجلاً كناشر جـرب تمنشن ناشر آخـر" },
SUCCESS_LANG_SET: "تم تعيين لغة البوت إلى العربية.",
SUCCESS_PREFIX_SET: "تم تعيين بادئة البوت الجديدة إلى `{newPrefix}`<a:6HypedDance:1401907058047189127>",
...
SUCCESS_AD_CHANNEL_SET_DESC: "تم تعيين قناة {channel} لاستقبال تحديثات الناشرين اليومية <:2BCrikka:1414595716864806962>",
...
PUBLISHER_ADD_FAIL_ALREADY: "(مضـاف بالفـعـل <a:6fuckyou:1401255926807400559>)",
...
ERROR_CHANNEL_NOT_MONITORED: { title: "✥ هـمم ... ؟", description: "الـقنـاة التي حددتها ليست ضمن قنوات المراقبة. عينها أولاً <a:6fuckyou:1401255926807400559>" },
...
SUMMARY_TOP_PUBLISHERS: "✶ اعلـى الـنـاشـريـن <a:6JaFaster:1414593247564660828>:",
SUMMARY_TOP_CHANNELS: "✶ اعلـى الـقـنوات <a:6Squish:1401842147799334934>:",
SUMMARY_TOTAL_POINTS: "✶ مجموع نقاـط السيرفـر:",
SUMMARY_NO_PUBLISHERS: "لا يوجـد ناشرون بعـد <:2ohshii:1421110454255747201>",
SUMMARY_NO_CHANNELS: "لا توجد قنوات بعـد <:2ohshii:1421110454255747201>"
}
};
...
// إصلاح Deprecation Warning - استخدام flags بدلاً من ephemeral
...
.setTitle("🏆 لائـحـة متصـدريـن النـشـر")
.setColor(custom.color)
.setFooter({ text: `صفحة ${page}/${totalPages} | Total: ${totalPublishers}` });
...
.addFields({ name: `✶ مجـموع نقاـط السيرفـر: (${totalServerPoints})`, value: '\u200b', inline: false });
